...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        this.attackerContract = await AttackerContractFactory.deploy(this.flashLoanPool.address, this.liquidityToken.address, this.rewarderPool.address, this.rewardToken.address);

        await this.attackerContract.executeAttack(TOKENS_IN_LENDER_POOL);
    });
